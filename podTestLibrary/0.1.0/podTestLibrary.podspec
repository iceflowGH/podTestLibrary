...
For socket.io 1.0+ and Swift.
  ...
  s.homepage         = 'https://github.com/iceflowGH/podTestLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'iceflowGH' => '838953209@qq.com' }
  s.source           = { :git => '/Users/guangzhuiyuandev/Desktop/cocoalib/podTestLibrary', :tag => '0.1.0' }
...
#  'podTestLibrary' => ['podTestLibrary/Assets/*.png']
  ...
  s.dependency 'Socket.IO-Client-Swift', '~> 9.0.0'
end
